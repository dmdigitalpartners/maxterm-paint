...
export const WHY_US = {
  ...
  sectionSubtitle:
    'Причините, поради които хората се връщат при нас, а не търсят другаде.',
  items: [
    {
      icon: 'Users',
      title: 'Правилният продукт за вашия проект',
      description:
        '16 години работа с обекти в Пловдив. Ще Ви насочим към точния продукт преди да платите. Не след като разберете, че е грешен.',
    },
    {
      icon: 'ShieldCheck',
      title: 'Знаете точно какво получавате',
      description:
        'Официален представител на Benjamin Moore, PPG, Baumit, Mapei и над 20 марки. Оригинален продукт, гарантиран на източника. Без замени, без изненади.',
    },
    {
      icon: 'Truck',
      title: 'Доставка без забавяне на обекта',
      description:
        'Собствен транспорт директно до обекта. Без изчакване, без наем на превоз, без риск работата да спре заради липсващ материал.',
    },
    {
      icon: 'Compass',
      title: 'Ясна посока от начало до край',
      description:
        'Не само продаваме. Отговаряме на въпроси, които още не сте задали. Количество, последователност, съвместимост. Преди да се объркате.',
    },
  ],
} as const
