  ...
  items: [
    {
      ...
      subtitle: 'Официален представител и гарантиран произход.',
      description:
        '16 години опит с обекти в Пловдив. Насочваме ви към точния продукт — преди да платите, не след.',
    },
    {
      icon: 'ShieldCheck',
      title: 'Материали с експертен съвет',
      subtitle: 'Доставка директно до вашия обект.',
      description:
        'Работим само с оригинални продукти от над 20 марки. Гарантиран произход, без замени и без изненади.',
    },
    {
      icon: 'Truck',
      title: 'Доставка без забавяне на обекта',
      description:
        'Собствен транспорт директно до обекта — без изчакване, без наем на превоз и без риск за забавяне.',
    },
    {
      icon: 'Compass',
      title: 'Ясна посока от начало до край',
      description:
        'Съветваме по количество, последователност и съвместимост. Отговаряме на въпросите, преди да са станали проблем.',
    },
  ],
} as const
