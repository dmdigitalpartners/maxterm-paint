...
export function ViberButton() {
  return (
    <a
      ...
      className="fixed z-40 w-16 h-16 rounded-full overflow-hidden hover:scale-110 active:scale-100 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7360F2]"
      style={{
